...
def figure_to_image(fig, dpi: int = 200) -> BytesIO:
    ...
    try:
        img_io = BytesIO()
        fig.savefig(img_io, format='png', dpi=dpi, bbox_inches='tight', facecolor='white')
        img_io.seek(0)
...
def insert_figure(canvas_obj: canvas.Canvas, fig, x: float, y: float, 
                   width: float, height: float, dpi: int = 200, 
...
def generate_page1(
    ...
    # 导入 1_1.py
    spec1 = importlib.util.spec_from_file_location("chart1_1", os.path.join(charts_dir, "1_1.py"))
    chart1_1 = importlib.util.module_from_spec(spec1)
    spec1.loader.exec_module(chart1_1)
    
    # 导入 1_2.py
    spec2 = importlib.util.spec_from_file_location("chart1_2", os.path.join(charts_dir, "1_2.py"))
    chart1_2 = importlib.util.module_from_spec(spec2)
    spec2.loader.exec_module(chart1_2)
    
    # 导入 1_3.py
    spec3 = importlib.util.spec_from_file_location("chart1_3", os.path.join(charts_dir, "1_3.py"))
    chart1_3 = importlib.util.module_from_spec(spec3)
    spec3.loader.exec_module(chart1_3)
    
    # 导入 1_4.py
    spec4 = importlib.util.spec_from_file_location("chart1_4", os.path.join(charts_dir, "1_4.py"))
    chart1_4 = importlib.util.module_from_spec(spec4)
    spec4.loader.exec_module(chart1_4)
    
    # 导入 1_5.py
    spec5 = importlib.util.spec_from_file_location("chart1_5", os.path.join(charts_dir, "1_5.py"))
    chart1_5 = importlib.util.module_from_spec(spec5)
    spec5.loader.exec_module(chart1_5)
    
    # 导入 1_6.py
    spec6 = importlib.util.spec_from_file_location("chart1_6", os.path.join(charts_dir, "1_6.py"))
    chart1_6 = importlib.util.module_from_spec(spec6)
    spec6.loader.exec_module(chart1_6)
    
    # 导入 2_1.py
    spec2_1 = importlib.util.spec_from_file_location("chart2_1", os.path.join(charts_dir, "2_1.py"))
    chart2_1 = importlib.util.module_from_spec(spec2_1)
    spec2_1.loader.exec_module(chart2_1)
    
    # 导入 2_2.py
    spec2_2 = importlib.util.spec_from_file_location("chart2_2", os.path.join(charts_dir, "2_2.py"))
    chart2_2 = importlib.util.module_from_spec(spec2_2)
    spec2_2.loader.exec_module(chart2_2)
    
    # 导入 2_3.py
    spec2_3 = importlib.util.spec_from_file_location("chart2_3", os.path.join(charts_dir, "2_3.py"))
    chart2_3 = importlib.util.module_from_spec(spec2_3)
    spec2_3.loader.exec_module(chart2_3)
    
    # 导入 2_4.py
    spec2_4 = importlib.util.spec_from_file_location("chart2_4", os.path.join(charts_dir, "2_4.py"))
    chart2_4 = importlib.util.module_from_spec(spec2_4)
    spec2_4.loader.exec_module(chart2_4)
    
    # 导入 2_5.py
    spec2_5 = importlib.util.spec_from_file_location("chart2_5", os.path.join(charts_dir, "2_5.py"))
    chart2_5 = importlib.util.module_from_spec(spec2_5)
    spec2_5.loader.exec_module(chart2_5)
    
    # 导入 3_1.py
    spec3_1 = importlib.util.spec_from_file_location("chart3_1", os.path.join(charts_dir, "3_1.py"))
    chart3_1 = importlib.util.module_from_spec(spec3_1)
    spec3_1.loader.exec_module(chart3_1)
    
    # 导入 3_2.py
    spec3_2 = importlib.util.spec_from_file_location("chart3_2", os.path.join(charts_dir, "3_2.py"))
    chart3_2 = importlib.util.module_from_spec(spec3_2)
    spec3_2.loader.exec_module(chart3_2)
    
    # 导入 3_3.py
    spec3_3 = importlib.util.spec_from_file_location("chart3_3", os.path.join(charts_dir, "3_3.py"))
    chart3_3 = importlib.util.module_from_spec(spec3_3)
    spec3_3.loader.exec_module(chart3_3)
    
    # 导入 3_4.py
    spec3_4 = importlib.util.spec_from_file_location("chart3_4", os.path.join(charts_dir, "3_4.py"))
    chart3_4 = importlib.util.module_from_spec(spec3_4)
    spec3_4.loader.exec_module(chart3_4)
    
    # 导入 4_1.py
    spec4_1 = importlib.util.spec_from_file_location("chart4_1", os.path.join(charts_dir, "4_1.py"))
    chart4_1 = importlib.util.module_from_spec(spec4_1)
    spec4_1.loader.exec_module(chart4_1)
    
    # 导入 4_2.py
    spec4_2 = importlib.util.spec_from_file_location("chart4_2", os.path.join(charts_dir, "4_2.py"))
    chart4_2 = importlib.util.module_from_spec(spec4_2)
    spec4_2.loader.exec_module(chart4_2)
    
    # 导入 5_1.py
    spec5_1 = importlib.util.spec_from_file_location("chart5_1", os.path.join(charts_dir, "5_1.py"))
    chart5_1 = importlib.util.module_from_spec(spec5_1)
    spec5_1.loader.exec_module(chart5_1)
    
    # 导入 5_2.py
    spec5_2 = importlib.util.spec_from_file_location("chart5_2", os.path.join(charts_dir, "5_2.py"))
    chart5_2 = importlib.util.module_from_spec(spec5_2)
    spec5_2.loader.exec_module(chart5_2)
    
    # 导入 6_4.py
    spec6_4 = importlib.util.spec_from_file_location("chart6_4", os.path.join(charts_dir, "6_4.py"))
    chart6_4 = importlib.util.module_from_spec(spec6_4)
    spec6_4.loader.exec_module(chart6_4)
    
    # 导入 6_5.py
    spec6_5 = importlib.util.spec_from_file_location("chart6_5", os.path.join(charts_dir, "6_5.py"))
    ...
    plot_asset_performance_attribution_table = chart3_4.plot_asset_performance_attribution_table
    ...
    plot_industry_attribution_profit_table = chart4_2.plot_industry_attribution_profit_table
    plot_industry_attribution_profit_chart = chart4_2.plot_industry_attribution_profit_chart
    ...
    try:
        ...
        # 底部：柱状图（左侧）和表格（右侧）
        h_bottom = max(row_heights['brinson_industry_bar'], row_heights['brinson_table'])
        ...
        fig23 = plot_brinson_attribution_table(data=safe_get('brinson'), return_figure=True, 
                                               ...
                                               show_title=True,
                                               table_fontsize=12)
        insert_figure(c, fig23, x_left + left_w + 5, y_cursor - h_bottom, right_w, h_bottom)
    ...
    try:
        print("  生成股票行业归因表格和图表...")
        h = max(row_heights['industry_attribution_table'], row_heights['industry_attribution_chart'])
        # 计算总高度：标题 + 两行图表
    ...
    try:
        print("  生成股票绩效归因表格和图表...")
        h = max(row_heights['stock_attribution_table'], row_heights['stock_attribution_chart'])
        # 计算总高度：标题 + 两行图表
        total_height = h * 2 + 10  # 两行图表 + 中间间距
        ensure_space(total_height + 22 + 10)
    ...
    try:
        print("  生成个股持仓节点表格和图表...")
        h = max(row_heights['stock_holding_nodes_table'], row_heights['stock_holding_nodes_chart'])
        ensure_space(h + 22 + 10)
    ...
    try:
        print("  生成期间交易表格和图表...")
        h = max(row_heights['period_transaction_table'], row_heights['period_transaction_chart'])
        ensure_space(h + 22 + 10)
